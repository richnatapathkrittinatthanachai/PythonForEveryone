tilecolor = {'yellow':100, 'red':200, 'gold':90,'grey':30}
...
print('------โปรแกรมคำนวณกระเบื้อง V.2 by Rich ------')
try:
    tiles = int(input('คุณต้องการปูกระเบื้องทั้งหมดกี่แผ่น: '))
    row = int(input('1 แถวต้องปูกระเบื้องกีแผ่น: '))  # 3 ชิ้นต่อแถว 
    color = input('กระเบื้องสีอะไร? [yellow / red / gold]: ')
except:
    print('กรุณากรอกข้อมูลเป็นตัวเลขเท่านั้น!')
    tiles = int(input('คุณต้องการปูกระเบื้องทั้งหมดกี่แผ่น: '))
    row = int(input('1 คุณต้องปูกระเบื้องกี่แผ่น: '))
    color = input('กระเบื้องสีอะไร? [yellow / red / gold]: ')
...
print('------คำนวณ------')
print('ต้องปูกระเบื้องทั้งหมด {} แผ่น'.format(total_row))
...
print('ยอดรวมทั้งหมดที่ต้องซื้อกระเบื้องเพิ่ม: {} แผ่น'.format(buy_more * tilecolor[color]))
